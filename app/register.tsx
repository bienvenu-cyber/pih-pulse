...
import { Mail, Lock, User, ArrowRight, Apple } from 'lucide-react-native';
...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Rediriger vers l'écran de saisie du code OTP reçu par e-mail
  ...
  const lowerAlphanumeric = (str: string) => {
    return str.toLowerCase().replace(/[^a-z0-9_]/g, '_') + '_' + Math.floor(1000 + Math.random() * 9000);
  };
          ...
          <View className="w-full max-w-[400px] self-center gap-8 py-6">
            ...
            <View className="items-center gap-1.5 mb-2">
              ...
              <Text className="text-sable font-inter text-xs">
                Inscrivez-vous pour rejoindre l’écosystème Pulse
              </Text>
            </View>
            ...
            <View className="gap-4 mt-2">
              ...
              <View className="flex-row justify-center items-center gap-1.5 mt-1">
                ...
                <Pressable onPress={handleGoToLogin} disabled={loading}>
