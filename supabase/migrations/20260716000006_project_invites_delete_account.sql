-- Invitations projet + suppression de compte (self-service)
...
-- Un seul pending par paire projet/invitee (partial unique)
...
-- Suppression de compte (utilisateur connecté uniquement)
...
begin
  ...
  -- Anonymise / purge données app (FKs profiles)
  ...
  -- Auth user (cascade éventuel selon config)
